...
DIRECTIVES = -std=c++11 -pedantic -Wall -Wextra -Wredundant-decls -std=c++11 -O3 -Wshadow -Wformat=2 -Wfloat-equal -Wcast-qual -Wcast-align -Wwrite-strings -Wpointer-arith -Wconversion -Wshift-overflow -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -c -I $(HEADER_PATH)
